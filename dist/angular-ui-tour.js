(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("angular"), require("angular-sanitize"), require("angular-scroll"), require("ez-ng"), require("angular-hotkeys"), require("tether"), require("hone"));
	else if(typeof define === 'function' && define.amd)
		define("uiTour", ["angular", "angular-sanitize", "angular-scroll", "ez-ng", "angular-hotkeys", "tether", "hone"], factory);
	else if(typeof exports === 'object')
		exports["uiTour"] = factory(require("angular"), require("angular-sanitize"), require("angular-scroll"), require("ez-ng"), require("angular-hotkeys"), require("tether"), require("hone"));
	else
		root["uiTour"] = factory(root["angular"], root["angular-sanitize"], root["angular-scroll"], root["ez-ng"], root["angular-hotkeys"], root["tether"], root["hone"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _angular2.default.module('bm.uiTour', ['ngSanitize', 'duScroll', 'ezNg', 'cfp.hotkeys']).run(run).value('Tether', _tether2.default || window.Tether).value('Hone', _hone2.default || window.Hone).constant('positionMap', __webpack_require__(17)).provider('TourConfig', __webpack_require__(18)).factory('uiTourBackdrop', __webpack_require__(19)).factory('TourHelpers', __webpack_require__(20)).factory('uiTourService', __webpack_require__(21)).factory('TourStepService', __webpack_require__(22)).controller('uiTourController', __webpack_require__(23)).directive('uiTour', __webpack_require__(24)).directive('tourStep', __webpack_require__(25)).name;
